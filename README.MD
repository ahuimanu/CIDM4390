...
6. also in webapi: `dotnet add package Microsoft.EntityFrameworkCore.Sqlite --version 3.1.10`
7. also in webapi: `dotnet add package Microsoft.EntityFrameworkCore.InMemory --version 3.1.10`
